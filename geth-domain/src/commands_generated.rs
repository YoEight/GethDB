...
impl<'a> DeleteStream<'a> {
  ...
  pub fn expectation_type(&self) -> StreamExpectation {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<StreamExpectation>(DeleteStream::VT_EXPECTATION_TYPE, Some(StreamExpectation::NONE)).unwrap()}
  }
  #[inline]
  pub fn expectation(&self) -> Option<flatbuffers::Table<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(DeleteStream::VT_EXPECTATION, None)}
  }
  #[inline]
  #[allow(non_snake_case)]
  pub fn expectation_as_expect_exists(&self) -> Option<ExpectExists<'a>> {
...
impl<'a: 'b, 'b> DeleteStreamBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_expectation_type(&mut self, expectation_type: StreamExpectation) {
    self.fbb_.push_slot::<StreamExpectation>(DeleteStream::VT_EXPECTATION_TYPE, expectation_type, StreamExpectation::NONE);
  }
  #[inline]
  pub fn add_expectation(&mut self, expectation: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(DeleteStream::VT_EXPECTATION, expectation);
  }
  #[inline]
