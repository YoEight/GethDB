...
pub mod geth {
    ...
    impl Commands {
        ...
        pub const ENUM_VALUES: &'static [Self] =
            &[Self::NONE, Self::AppendStream, Self::DeleteStream];
        /// Returns the variant's name or "" if unknown.
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
                Self::NONE => Some("NONE"),
    ...
    impl<'a> ExpectRevision<'a> {
        ...
        pub fn revision(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(ExpectRevision::VT_REVISION, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> ExpectRevisionBuilder<'a, 'b> {
        ...
        pub fn add_revision(&mut self, revision: u64) {
            self.fbb_
                .push_slot::<u64>(ExpectRevision::VT_REVISION, revision, 0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> ExpectRevisionBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> ProposedEvent<'a> {
        ...
        pub fn class(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ProposedEvent::VT_CLASS, None)
            }
        }
        #[inline]
        pub fn stream(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(ProposedEvent::VT_STREAM, None)
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> ProposedEventBuilder<'a, 'b> {
        ...
        pub fn add_class(&mut self, class: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ProposedEvent::VT_CLASS, class);
        }
        #[inline]
        pub fn add_stream(&mut self, stream: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ProposedEvent::VT_STREAM, stream);
        }
        #[inline]
        pub fn add_payload(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ProposedEvent::VT_PAYLOAD, payload);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> ProposedEventBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> AppendStream<'a> {
        ...
        pub fn stream(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AppendStream::VT_STREAM, None)
            }
        }
        #[inline]
            ...
            unsafe {
                self._tab
                    .get::<StreamExpectation>(
                        AppendStream::VT_EXPECTATION_TYPE,
        ...
        pub fn events(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ProposedEvent<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ProposedEvent>>,
                >>(AppendStream::VT_EVENTS, None)
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ProposedEvent>>,
    ...
    pub struct AppendStreamArgs<'a> {
        ...
        pub events: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ProposedEvent<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> AppendStreamBuilder<'a, 'b> {
        ...
        pub fn add_stream(&mut self, stream: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AppendStream::VT_STREAM, stream);
        }
        #[inline]
        ...
        pub fn add_events(
            ...
            events: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<ProposedEvent<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AppendStream::VT_EVENTS, events);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> AppendStreamBuilder<'a, 'b> {
            let start = _fbb.start_table();
            AppendStreamBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    impl<'a> Command<'a> {
        ...
        pub fn command_type(&self) -> Commands {
            ...
            unsafe {
                self._tab
                    .get::<Commands>(Command::VT_COMMAND_TYPE, Some(Commands::NONE))
                    .unwrap()
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_union::<Commands, _>(
                    ...
                    false,
                    |key, v, pos| match key {
                        Commands::AppendStream => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<AppendStream>>(
                                "Commands::AppendStream",
                                pos,
                            ),
                        Commands::DeleteStream => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<DeleteStream>>(
                                "Commands::DeleteStream",
                                pos,
                            ),
                        _ => Ok(()),
    ...
    impl<'a: 'b, 'b> CommandBuilder<'a, 'b> {
        ...
        pub fn add_command_type(&mut self, command_type: Commands) {
            self.fbb_
                .push_slot::<Commands>(Command::VT_COMMAND_TYPE, command_type, Commands::NONE);
        }
        #[inline]
        pub fn add_command(
            &mut self,
