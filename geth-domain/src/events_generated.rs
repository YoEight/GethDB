...
pub mod geth {
    ...
    pub const ENUM_VALUES_EVENTS: [Events; 3] =
        [Events::NONE, Events::RecordedEvent, Events::StreamDeleted];
    ...
    impl Events {
        ...
        pub const ENUM_VALUES: &'static [Self] =
            &[Self::NONE, Self::RecordedEvent, Self::StreamDeleted];
    ...
    impl<'a> RecordedEvent<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.stream_name {
                builder.add_stream_name(x);
            }
        ...
        pub fn revision(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(RecordedEvent::VT_REVISION, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn stream_name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(RecordedEvent::VT_STREAM_NAME, None)
            }
        }
        #[inline]
        pub fn class(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(RecordedEvent::VT_CLASS, None)
            }
        }
        #[inline]
        pub fn created(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(RecordedEvent::VT_CREATED, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> RecordedEventBuilder<'a, 'b> {
        ...
        pub fn add_class(&mut self, class: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(RecordedEvent::VT_CLASS, class);
        }
        #[inline]
        pub fn add_created(&mut self, created: i64) {
            self.fbb_
                .push_slot::<i64>(RecordedEvent::VT_CREATED, created, 0);
        }
        #[inline]
        pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(RecordedEvent::VT_DATA, data);
        }
        #[inline]
        pub fn add_metadata(
            &mut self,
            metadata: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                RecordedEvent::VT_METADATA,
                metadata,
    ...
    impl<'a> StreamDeleted<'a> {
        ...
        pub const VT_REVISION: flatbuffers::VOffsetT = 6;
        pub const VT_CREATED: flatbuffers::VOffsetT = 8;
        ...
        pub fn stream_name(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(StreamDeleted::VT_STREAM_NAME, None)
            }
        }
        #[inline]
        pub fn revision(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(StreamDeleted::VT_REVISION, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn created(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(StreamDeleted::VT_CREATED, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> StreamDeletedBuilder<'a, 'b> {
        ...
        pub fn add_revision(&mut self, revision: u64) {
            self.fbb_
                .push_slot::<u64>(StreamDeleted::VT_REVISION, revision, 0);
        }
        #[inline]
        pub fn add_created(&mut self, created: i64) {
            self.fbb_
                .push_slot::<i64>(StreamDeleted::VT_CREATED, created, 0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> StreamDeletedBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> Event<'a> {
        ...
        pub fn event_type(&self) -> Events {
            ...
            unsafe {
                self._tab
                    .get::<Events>(Event::VT_EVENT_TYPE, Some(Events::NONE))
                    .unwrap()
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_union::<Events, _>(
                    ...
                    false,
                    |key, v, pos| match key {
                        Events::RecordedEvent => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<RecordedEvent>>(
                                "Events::RecordedEvent",
                                pos,
                            ),
                        Events::StreamDeleted => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<StreamDeleted>>(
    ...
    impl<'a: 'b, 'b> EventBuilder<'a, 'b> {
        ...
        pub fn add_event_type(&mut self, event_type: Events) {
            self.fbb_
                .push_slot::<Events>(Event::VT_EVENT_TYPE, event_type, Events::NONE);
        }
        #[inline]
