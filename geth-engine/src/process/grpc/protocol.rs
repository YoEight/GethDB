...
use geth_common::generated::protocol::protocol_server::Protocol;
use geth_common::{
    AppendStream, Direction, GetProgramError, Operation, OperationIn, OperationOut, ProgramKilled,
    ProgramListed, ProgramObtained, ReadStream, ReadStreamCompleted, ReadStreamResponse, Record,
    Reply, Subscribe, SubscribeToStream, SubscriptionConfirmation, SubscriptionEvent,
    UnsubscribeReason,
};
use uuid::Uuid;
...
impl Protocol for ProtocolImpl {
    ...
    async fn delete_stream(
        &self,
        _request: Request<protocol::DeleteStreamRequest>,
    ) -> Result<Response<protocol::DeleteStreamResponse>, Status> {
        // Not yet implemented
        Err(Status::unimplemented("delete_stream is not implemented"))
    }

    async fn subscribe(
        &self,
        _request: Request<protocol::SubscribeRequest>,
    ...
    async fn list_programs(
        &self,
        _request: Request<protocol::ListProgramsRequest>,
    ) -> Result<Response<protocol::ListProgramsResponse>, Status> {
        // Not yet implemented
        Err(Status::unimplemented("list_programs is not implemented"))
    }
